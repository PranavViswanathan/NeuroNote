...
def test_process_note_queues_job() -> None:
    payload = {
        "note_id": "note-1",
...
def test_process_status_returns_existing_job() -> None:
    payload = {
        "note_id": "note-2",
...
def test_process_note_rejects_invalid_payload() -> None:
    payload = {
        "note_id": "",
        "content_text": "",
    }
...
def test_process_status_missing_job_returns_404() -> None:
